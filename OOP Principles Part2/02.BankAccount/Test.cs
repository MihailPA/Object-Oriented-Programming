...
namespace _02.BankAccount
{
    public class TestAccounts
    {
        ...
        {
            var bank = new Bank();
            bank.AddAccount(new DepositAccount(new IndividualCustomer("Roskata", "Plevneliev"), 878, 5));
            bank.AddAccount(new LoanAccount(new CompanyCustomers("Opel", "Astra"), 2005, 5));
            bank.AddAccount(new MortgageAccount(new IndividualCustomer("BateBoiko", "Borisov"), 8565, 5));
